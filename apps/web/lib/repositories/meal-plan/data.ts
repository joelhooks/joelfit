...
export const wifeMealPlan: Omit<MealPlan, keyof { id: string; slug: string; createdAt: Date; updatedAt: Date }> = {
  ...
  calories: 1800,
  timeline: [
    { time: "7:00 AM", slot: "A", meal: "Breakfast", calories: 300, protein: 25, carbs: 35, fat: 10, container: "Mason jar" },
    { time: "11:30 AM", slot: "C", meal: "Lunch", calories: 450, protein: 35, carbs: 55, fat: 15, container: "3-comp glass" },
    { time: "3:00 PM", slot: "D", meal: "Mid-day Meal", calories: 400, protein: 30, carbs: 45, fat: 15, container: "3-comp glass" },
    { time: "7:00 PM", slot: "E", meal: "Dinner", calories: 350, protein: 25, carbs: 35, fat: 12, container: "3-comp glass" },
    { time: "9:00 PM", slot: "F", meal: "Night Snack", calories: 200, protein: 15, carbs: 20, fat: 7, container: "Small glass" }
  ],
  mealStructure: {
    breakfast: {
      title: "A: Breakfast (300 cal)",
      items: [
        "½ cup oats (100 cal, 18g C)",
        "1 scoop protein powder (120 cal, 24g P)",
    ...
    lunch: {
      title: "C: Lunch (450 cal)",
      items: [
        "6oz lean protein (180 cal, 35g P)",
        "1.5 cups complex carb (180 cal, 45g C)",
        "2 cups vegetables (80 cal, 16g C)",
        "1 tbsp healthy fats (120 cal, 13g F)",
        "Sauce (20 cal, 2g F)"
      ]
    },
    midDay: {
      title: "D: Mid-day Meal (400 cal)",
      items: [
        "5oz lean protein (150 cal, 30g P)",
        "1 cup complex carb (120 cal, 30g C)",
        "2 cups vegetables (80 cal, 16g C)",
        "1 tbsp healthy fats (120 cal, 13g F)",
        "Sauce (20 cal, 2g F)"
    ...
    dinner: {
      title: "E: Dinner (350 cal)",
      items: [
        "4oz lean protein (120 cal, 24g P)",
        "1 cup complex carb (120 cal, 30g C)",
        "2 cups vegetables (80 cal, 15g C)",
        "½ tbsp healthy fats (60 cal, 7g F)",
        "Sauce (20 cal, 2g F)"
      ]
    },
    nightSnack: {
  ...
  portions: {
    protein: "4-6 oz per main meal",
    carbs: "1-1.5 cups per main meal",
    vegetables: "2 cups per main meal",
    fats: "0.5-1 tbsp per main meal"
  },
  weeklyPrep: {
    proteins: [
      "1.25 lbs chicken",
